...
class Text_Wiki_Parse_Tiki_Box extends Text_Wiki_Parse {
...
if (!class_exists('Text_Wiki_Parse_Box', false)) {
    class Text_Wiki_Parse_Box extends Text_Wiki_Parse_Tiki_Box
    {
    }
}
