...
class Text_Wiki_Parse_Tiki_Center extends Text_Wiki_Parse {
...
if (!class_exists('Text_Wiki_Parse_Center', false)) {
    class Text_Wiki_Parse_Center extends Text_Wiki_Parse_Tiki_Center
    {
    }
}
