...
class Text_Wiki_Parse_Tiki_Preformatted extends Text_Wiki_Parse {
...
if (!class_exists('Text_Wiki_Parse_Preformatted', false)) {
    class Text_Wiki_Parse_Preformatted extends Text_Wiki_Parse_Tiki_Preformatted
    {
    }
}
