...
class Text_Wiki_Parse_Tiki_Strong extends Text_Wiki_Parse {
...
if (!class_exists('Text_Wiki_Parse_Strong', false)) {
    class Text_Wiki_Parse_Strong extends Text_Wiki_Parse_Tiki_Strong
    {
    }
}
