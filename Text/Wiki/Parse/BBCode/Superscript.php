 ...
 */
class Text_Wiki_Parse_BBCode_Superscript extends Text_Wiki_Parse
{
    // {{{ Properties
...
// }}}
if (!class_exists('Text_Wiki_Parse_Superscript', false)) {
    class Text_Wiki_Parse_Superscript extends Text_Wiki_Parse_BBCode_Superscript
    {
    }
}
/*
