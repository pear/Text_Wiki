 ...
 */
class Text_Wiki_Parse_BBCode_Font extends Text_Wiki_Parse {
...
if (!class_exists('Text_Wiki_Parse_Font', false)) {
    class Text_Wiki_Parse_Font extends Text_Wiki_Parse_BBCode_Font
    {
    }
}
